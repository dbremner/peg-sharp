// Machine generated by peg-sharp 0.3.294.0 from Test9.peg.
using System;
...
internal sealed partial class Test9
{
	public Test9()
	{
	...
	private State DoParseExprRule(State _state, List<Result> _outResults)
	{
		...
		_state = DoChoice(_state, results,
			(s, r) => DoSequence(s, r,
				...
				(s2, r2) => DoParseLiteral(s2, r2, "b")),
			(s, r) => DoSequence(s, r,
				(s2, r2) => DoParseLiteral(s2, r2, "c"),
				(s2, r2) => DoRepetition(s2, r2, 0, 2147483647,
					(s3, r3) => DoParseLiteral(s3, r3, "d")),
	...
	{
		public Result(Test9 parser, int index, int length, string input, double value)
		{
			m_parser = parser;
			m_index = index;
			m_length = length;
