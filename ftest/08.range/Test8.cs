// Machine generated by peg-sharp 0.3.211.0 from Test8.peg.
using System;
...
internal sealed partial class Test8
{
	...
	private State DoParseExprRule(State _state, List<Result> _outResults)
	{
		...
		_state = DoChoice(_state, results,
			(s, r) => DoParseRange(s, r, false, "abc", string.Empty, null, "[abc]"),
			(s, r) => DoParseRange(s, r, false, string.Empty, "eh", null, "[e-h]"),
			(s, r) => DoParseRange(s, r, false, "mnz", "pruw", null, "[mnzp-ru-w]"),
	...
	{
		public Result(Test8 parser, int index, string text, double value)
		{
			m_parser = parser;
			m_index = index;
			m_text = text;
