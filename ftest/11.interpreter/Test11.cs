// Machine generated by peg-sharp 0.4.693.0 from 11.interpreter/Test11.peg.
using System;
...
internal sealed partial class Test11
{
	...
	// Assignment := Identifier '=' S Compare
	...
	// If := 'if' S Compare 'then' S Statements 'else' S Statements 'end' S
	...
	// Statements := (If / While / Assignment / Compare)+
	private State DoParseStatementsRule(State _state, List<Result> _outResults)
	{
		...
		_state = DoRepetition(_state, results, 1, 2147483647,
			delegate (State s, List<Result> r) {return DoChoice(s, r,
				delegate (State s2, List<Result> r2) {return DoParse(s2, r2, "If");},
				delegate (State s2, List<Result> r2) {return DoParse(s2, r2, "While");},
	...
	// While := 'while' S Compare 'do' S Statements 'end' S
	...
	// Identifier := !(('do' / 'else' / 'end' / 'if' / 'then' / 'while') ![a-zA-Z0-9]) [a-zA-Z] [a-zA-Z0-9]* S
