// Machine generated by peg-sharp 0.4.738.0 from source/Parser.peg.
using System;
...
internal sealed partial class Parser
{
	...
	// PegFile := S (Setting / Comment)+ (Include / Rule / RuleEpilog / RuleProlog / Comment)+
	...
	private State DoParseSetting1Rule(State _state, List<Result> _outResults)
	{
		...
		_state = DoSequence(_state, results,
			...
			delegate (State s, List<Result> r) {return DoParseLiteral(s, r, "=");},
			delegate (State s, List<Result> r) {return DoParse(s, r, "S");},
			delegate (State s, List<Result> r) {return DoParseLiteral(s, r, "none");},
			delegate (State s, List<Result> r) {return DoParse(s, r, "S");});
