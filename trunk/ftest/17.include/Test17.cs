// Machine generated by peg-sharp 0.4.1021.0 from 17.include/Test17.peg.
...
internal sealed partial class Test17
{
	...
	{
		public Result(Test17 parser, int index, int length, string input, double value)
		{
			m_parser = parser;
			m_index = index;
			m_length = length;
