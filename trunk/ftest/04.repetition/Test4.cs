// Machine generated by peg-sharp 0.3.279.0 from Test4.peg.
using System;
...
internal sealed partial class Test4
{
	public Test4()
	{
	...
	{
		public Result(Test4 parser, int index, int length, string input, double value)
		{
			m_parser = parser;
			m_index = index;
			m_length = length;
