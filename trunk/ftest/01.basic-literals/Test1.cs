// Machine generated by peg-sharp 0.3.279.0 from Test1.peg.
using System;
...
internal sealed partial class Test1
{
	...
	private State DoParseExprRule(State _state, List<Result> _outResults)
	{
		...
		_state = DoParseLiteral(_state, results, "x");
	...
	{
		public Result(Test1 parser, int index, int length, string input, double value)
		{
			m_parser = parser;
			m_index = index;
			m_length = length;
