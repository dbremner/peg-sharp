// Machine generated by peg-sharp 0.4.1021.0 from 05.sub-expression/Test5.peg.
...
internal sealed partial class Test5
{
	public Test5()
	{
			...
			delegate (State s, List<Result> r) {return DoRepetition(s, r, 0, 2147483647,
				delegate (State s2, List<Result> r2) {return DoSequence(s2, r2,
					...
					delegate (State s3, List<Result> r3) {return DoChoice(s3, r3,
						delegate (State s4, List<Result> r4) {return DoParseLiteral(s4, r4, "x");},
						delegate (State s4, List<Result> r4) {return DoParseLiteral(s4, r4, "y");});});});});
	...
	{
		public Result(Test5 parser, int index, int length, string input, double value)
		{
			m_parser = parser;
			m_index = index;
			m_length = length;
