// Machine generated by peg-sharp 0.4.1021.0 from 06.back-tracking/Test6.peg.
...
internal sealed partial class Test6
{
	public Test6()
	{
	...
	private State DoParseExprRule(State _state, List<Result> _outResults)
	{
		...
		List<Result> results = new List<Result>();
			...
			delegate (State s, List<Result> r) {return DoSequence(s, r,
				delegate (State s2, List<Result> r2) {return DoParseLiteral(s2, r2, "x");},
				delegate (State s2, List<Result> r2) {return DoParseLiteral(s2, r2, "y");},
				delegate (State s2, List<Result> r2) {return DoParseLiteral(s2, r2, "z");});},
			delegate (State s, List<Result> r) {return DoSequence(s, r,
				delegate (State s2, List<Result> r2) {return DoParseLiteral(s2, r2, "x");},
				delegate (State s2, List<Result> r2) {return DoParseLiteral(s2, r2, "y");},
				delegate (State s2, List<Result> r2) {return DoParseLiteral(s2, r2, "w");});});
	...
	{
		public Result(Test6 parser, int index, int length, string input, double value)
		{
			m_parser = parser;
			m_index = index;
			m_length = length;
