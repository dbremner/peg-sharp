// Machine generated by peg-sharp 0.3.321.0 from Test6.peg.
using System;
...
internal sealed partial class Test6
{
	...
	private State DoParseExprRule(State _state, List<Result> _outResults)
	{
		...
		_state = DoChoice(_state, results,
			(s, r) => DoSequence(s, r,
				(s2, r2) => DoParseLiteral(s2, r2, "x"),
				(s2, r2) => DoParseLiteral(s2, r2, "y"),
				(s2, r2) => DoParseLiteral(s2, r2, "z")),
			(s, r) => DoSequence(s, r,
				(s2, r2) => DoParseLiteral(s2, r2, "x"),
				(s2, r2) => DoParseLiteral(s2, r2, "y"),
				(s2, r2) => DoParseLiteral(s2, r2, "w")));
