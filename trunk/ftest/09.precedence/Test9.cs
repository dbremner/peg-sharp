// Machine generated by peg-sharp 0.4.1021.0 from 09.precedence/Test9.peg.
	...
	private State DoParseExprRule(State _state, List<Result> _outResults)
	{
		...
		List<Result> results = new List<Result>();
			...
			delegate (State s, List<Result> r) {return DoSequence(s, r,
				...
				delegate (State s2, List<Result> r2) {return DoParseLiteral(s2, r2, "b");});},
			delegate (State s, List<Result> r) {return DoSequence(s, r,
				delegate (State s2, List<Result> r2) {return DoParseLiteral(s2, r2, "c");},
				delegate (State s2, List<Result> r2) {return DoRepetition(s2, r2, 0, 2147483647,
					delegate (State s3, List<Result> r3) {return DoParseLiteral(s3, r3, "d");});},
