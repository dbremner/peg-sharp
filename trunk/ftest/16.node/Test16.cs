// Machine generated by peg-sharp 0.4.693.0 from 16.node/Test16.peg.
using System;
	...
	private State DoParseExprRule(State _state, List<Result> _outResults)
	{
		...
		_state = DoSequence(_state, results,
			...
			delegate (State s, List<Result> r) {return DoSequence(s, r,
				delegate (State s2, List<Result> r2) {return DoParse(s2, r2, "Product");},
				delegate (State s2, List<Result> r2) {return DoRepetition(s2, r2, 0, 2147483647,
					delegate (State s3, List<Result> r3) {return DoSequence(s3, r3,
						...
						delegate (State s4, List<Result> r4) {return DoParse(s4, r4, "Product");});});});});
