// Machine generated by peg-sharp 0.4.693.0 from benchmark/Benchmark.peg.
using System;
...
internal sealed partial class Benchmark
{
	...
	private State DoParseProgramRule(State _state, List<Result> _outResults)
	{
		...
		_state = DoSequence(_state, results,
			delegate (State s, List<Result> r) {return DoRepetition(s, r, 0, 2147483647,
				delegate (State s2, List<Result> r2) {return DoParseRange(s2, r2, false, " \t\r\n", string.Empty, null, "[ \t\r\n]");});},
			delegate (State s, List<Result> r) {return DoRepetition(s, r, 1, 2147483647,
				delegate (State s2, List<Result> r2) {return DoParse(s2, r2, "Statement");});});
		...
		_state = DoChoice(_state, results,
			delegate (State s, List<Result> r) {return DoSequence(s, r,
				...
				delegate (State s2, List<Result> r2) {return DoRepetition(s2, r2, 0, 2147483647,
					delegate (State s3, List<Result> r3) {return DoParseRange(s3, r3, false, " \t\r\n", string.Empty, null, "[ \t\r\n]");});},
				delegate (State s2, List<Result> r2) {return DoParse(s2, r2, "Compare");},
				...
				delegate (State s2, List<Result> r2) {return DoRepetition(s2, r2, 1, 2147483647,
					delegate (State s3, List<Result> r3) {return DoParse(s3, r3, "Statement");});},
			...
			delegate (State s, List<Result> r) {return DoSequence(s, r,
				...
				delegate (State s2, List<Result> r2) {return DoRepetition(s2, r2, 0, 2147483647,
					delegate (State s3, List<Result> r3) {return DoParseRange(s3, r3, false, " \t\r\n", string.Empty, null, "[ \t\r\n]");});},
				delegate (State s2, List<Result> r2) {return DoParse(s2, r2, "Compare");});},
			delegate (State s, List<Result> r) {return DoParse(s, r, "Compare");});
			...
			delegate (State s, List<Result> r) {return DoRepetition(s, r, 0, 1,
				delegate (State s2, List<Result> r2) {return DoSequence(s2, r2,
					...
					delegate (State s3, List<Result> r3) {return DoRepetition(s3, r3, 0, 2147483647,
						delegate (State s4, List<Result> r4) {return DoParseRange(s4, r4, false, " \t\r\n", string.Empty, null, "[ \t\r\n]");});},
	...
	// Identifier := !(('do' / 'else' / 'end' / 'if' / 'then' / 'while') ![a-zA-Z0-9]) [a-zA-Z] [a-zA-Z0-9]* [ \t\r\n]*
	private State DoParseIdentifierRule(State _state, List<Result> _outResults)
	{
		...
		_state = DoSequence(_state, results,
			delegate (State s, List<Result> r) {return DoNAssert(s, r,
				delegate (State s2, List<Result> r2) {return DoSequence(s2, r2,
					delegate (State s3, List<Result> r3) {return DoChoice(s3, r3,
						delegate (State s4, List<Result> r4) {return DoParseLiteral(s4, r4, "do");},
						delegate (State s4, List<Result> r4) {return DoParseLiteral(s4, r4, "else");},
						delegate (State s4, List<Result> r4) {return DoParseLiteral(s4, r4, "end");},
						delegate (State s4, List<Result> r4) {return DoParseLiteral(s4, r4, "if");},
						delegate (State s4, List<Result> r4) {return DoParseLiteral(s4, r4, "then");},
						delegate (State s4, List<Result> r4) {return DoParseLiteral(s4, r4, "while");});},
					delegate (State s3, List<Result> r3) {return DoNAssert(s3, r3,
						delegate (State s4, List<Result> r4) {return DoParseRange(s4, r4, false, string.Empty, "azAZ09", null, "[a-zA-Z0-9]");});});});},
	...
	private State DoParseLiteral(State state, List<Result> results, string literal)
	{
		...
		results.Add(new Result(this, j, literal.Length, m_input, default(string)));
